...
class GetReleasingSoonMoviesUseCase implements UsecaseWithoutParams<List<MovieEntity>> {
  final IMovieRepository _repository;

  GetReleasingSoonMoviesUseCase(this._repository);
  @override
  Future<Either<Exception, List<MovieEntity>>> call() async {
    try {
      var data = await _repository.getReleasingSoonMovies();
      return Right(data);
    } catch (ex) {
